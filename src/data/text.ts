const firstP: string =
	"Hundida en la oscuridad de las calles frías de Jaiva, Artemisa sale de su casa una fría noche de otoño. Encaminada hacia el Hotel de Mario, la más lujosa red de prostitución del país, a cumplir con su trabajo, cuando un grupo de sicarios la intercepta para hacerle cobrar el dinero que le debe a la mafia paraguaya.";
const secondP: string =
	"Ella es una mujer trans, sobreviviente de la pandemia y de la sociedad. Ella paga lo que debe.";
const thirdP: string =
	"Al alba, Artemisa está muerta. Su cadáver, violentado y escarchado, es hallado por la policía.";
